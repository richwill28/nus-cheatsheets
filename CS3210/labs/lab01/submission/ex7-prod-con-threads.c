 ...
 * variables.
 * Compile: gcc -pthread ex7-prod-con-threads.c -o ex7-prod-con-threads.out
 * Run: ./ex7-prod-con-threads.out <THREAD_DELAY> <BUFFER_CAPACITY>
 *
...
int THREAD_DELAY, BUFFER_CAPACITY;
...
//       ensured with the use of mutex and condition variables.
